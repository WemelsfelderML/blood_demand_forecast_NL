...
df_list <- lapply(list(P, R, Pt, Rt), function(df) {
  ...
  # Numerify
  df1$quantity <- as.numeric(as.character(df1$quantity))
...
save_html(html, paste0(MONTHLYDIR, "forecasts/", type, "_rwy", rw_years, ".html"), background = "white", libdir = "lib")
```
...
save_html(html, paste0(WEEKLYDIR, "forecasts/", type, "_rwy", rw_years, ".html"), background = "white", libdir = "lib")
```
