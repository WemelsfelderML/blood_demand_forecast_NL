...
wbeginning <- head(tail(weekly$startdate, ((rw_years+1) * 52 + 1)), 1) # Define beginning of (weekly) time here
```
...
type <- "red"
# # save_forecast(fdf, months = TRUE, modelname, monthly, paste0(MONTHLYDIR, type, ".csv"), reverse_adj, rw_years) # Check pffunctions.R
...
type <- "plat"
# # save_forecast(fdf, months = TRUE, modelname, monthly, paste0(MONTHLYDIR, type, ".csv"), reverse_adj, rw_years)
write.csv(fdf, paste0(MONTHLYDIR, type, "_rwy", rw_years, ".csv"), row.names = FALSE)
```
...
chosen.model <- select_model(beginning, series.ts, "weekly", rw_years)
modelname <- modelnames[chosen.model]
cat("Red; ", modelname, file=paste0("rw_testing/w_errors_rwy", rw_years, "_chosen.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_mean.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_all.txt"), append=TRUE)
```
...
type <- "red"
# # save_forecast(fdf, months = TRUE, modelname, monthly, paste0(WEEKLYDIR, type, ".csv"), reverse_adj, rw_years)
...
chosen.model <- select_model(beginning, series.ts, "weekly", rw_years)
modelname <- modelnames[chosen.model]
cat("O-; ", modelname, file=paste0("rw_testing/w_errors_rwy", rw_years, "_chosen.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_mean.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_all.txt"), append=TRUE)
```
...
chosen.model <- select_model(beginning, series.ts, "weekly", rw_years)
modelname <- modelnames[chosen.model]
cat("A-; ", modelname, file=paste0("rw_testing/w_errors_rwy", rw_years, "_chosen.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_mean.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_all.txt"), append=TRUE)
```
...
chosen.model <- select_model(beginning, series.ts, "weekly", rw_years)
modelname <- modelnames[chosen.model]
cat("B-; ", modelname, file=paste0("rw_testing/w_errors_rwy", rw_years, "_chosen.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_mean.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_all.txt"), append=TRUE)
```
...
chosen.model <- select_model(beginning, series.ts, "weekly", rw_years)
modelname <- modelnames[chosen.model]
cat("AB-; ", modelname, file=paste0("rw_testing/w_errors_rwy", rw_years, "_chosen.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_mean.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_all.txt"), append=TRUE)
```
...
chosen.model <- select_model(beginning, series.ts, "weekly", rw_years)
modelname <- modelnames[chosen.model]
cat("Plat; ", modelname, file=paste0("rw_testing/w_errors_rwy", rw_years, "_chosen.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_mean.txt"), append=TRUE)
cat("\n", file=paste0("rw_testing/w_errors_rwy", rw_years, "_all.txt"), append=TRUE)
```
